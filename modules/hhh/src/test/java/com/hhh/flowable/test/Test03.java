...
public class Test03 {
    ...
    public void testDeploy(){
        ...
        Deployment deploy = repositoryService.createDeployment()
                .addClasspathResource("MyHolidayUI.bpmn20.xml")// 关联要部署的流程文件
                .name("FlowableUI请求流程")
                .deploy() ;// 部署流程
    ...
    public void testRunProcess(){
        ...
        // 启动流程实例
        ProcessInstance holidayRequest = runtimeService.startProcessInstanceById("MyHolidayUI:1:35004", variables);
    ...
    public void testHistory(){
        ...
        List<HistoricActivityInstance> list = historyService.createHistoricActivityInstanceQuery()
                .processDefinitionId("MyHolidayUI:1:35004")
