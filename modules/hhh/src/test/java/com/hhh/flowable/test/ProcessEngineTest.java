...
public class ProcessEngineTest {
    ...
    public void processEngine01(){
        ...
        configuration.setJdbcPassword("Huang123.");
        configuration.setJdbcUrl("jdbc:mysql://localhost:3306/flowable?serverTimezone=UTC&nullCatalogMeansCurrent=true");
        // 如果数据库中的表结构不存在就新建 org.flowable.engine.impl.db.ProcessDbSchemaManager#performSchemaOperationsProcessEngineBuild在这边使用
